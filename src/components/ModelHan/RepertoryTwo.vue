...
<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="wsize" label="库存数量"></el-table-column>
      <el-table-column prop="zongJi" label="库存成本(元)"></el-table-column>
    </el-table>
    <div class="block">
      <el-pagination
...
export default {
  ...
  methods: {
    loadAll() {
      return [
        this.axios
          .get("http://localhost:50774/api/RepertoryBalance")
          .then((response) => {
