<template>
  <div>
    <div style="float: lift; font-size: 30px">入出库单</div>
    ...
    <div>
      ...
      <div>
        <el-table :data="tableData" border style="width: 100%" prop="re">
          ...
          <el-table-column prop="cukus" label="入库数量"></el-table-column>
      ...
      <div>
        <el-button type="primary" @click="UptC()">入库</el-button>
