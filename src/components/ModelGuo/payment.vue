...
<template>
  <div>
    <div>
      <table>
        <tr>
          ...
          <!-- <付款单新增组件-->
          <td>
            &nbsp;&nbsp;&nbsp;<el-button size="mini" plain>批量操作</el-button>
          </td>
    ...
    >
      ...
      <el-table-column prop="rppayer" label="供应方" width="180">
      </el-table-column>
      <el-table-column prop="rcreateTime" label="结算方式" width="180">
      </el-table-column>
      ...
      <el-table-column fixed="right" label="操作" width="100">
        <template slot-scope="scope">
            <Fkd v-bind:id=scope.row.rpid></Fkd>
...
<script>
import Fkd from '@/components/ModelGuo/Fkd'
  ...
  methods: {
    ...
    async fetchData(val) {
      const res = await this.axios
        .get("http://localhost:50774/api/payment", {
          params: {
            FKF: this.state,
            value: this.value[0],
            value1: this.value[1],
