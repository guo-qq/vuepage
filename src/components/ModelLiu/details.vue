        ...
        <div>
            <table style="width:100%">
                <tr>
                    <td><span>待审核</span></td>
                    <td><h1>销售单</h1> </td>
                    <td><span>单据编号:</span><label for=""></label></td>
                </tr>
            </table>
        </div>
        <div>
            <el-form :inline="true" :model="form" :rules="rules" ref="form" class="demo-form-inline">
                    ...
                    <el-form-item label="客户:" >
                        <el-input v-model="form.SsClient" placeholder="客户名称/编码" style="width: 140px"></el-input>
                    </el-form-item>
                    <el-form-item label="经手人" >
                        <el-input v-model="form.SsHandle" placeholder="姓名/手机号" style="width: 140px"></el-input>
                    </el-form-item>
...
<script>
  export default {
    data() {
         this.axios.get('http://localhost:50774/api/DifSalesSingle?ssid='+this.$route.query.id).then(function(data){
             
                this.form.SsWarehouse=data.SsWarehouse,
                this.form.SsClient=data.SsClient,
                this.form.SsHandle=data.SsHandle,
                this.form.SsYwDate=data.SsYwDate,
                this.form.SsDiscount=data.SsDiscount,
                this.form.SsZkMoney=data.SsZkMoney,
                this.form.SsFjMoney=data.SsFjMoney,
                this.form.SsMode=data.SsMode,
                this.form.SsRemark=data.SsRemark,
                this.form.SsPrice=data.SsPrice,
                this.form.SsSjMoney=data.SsSjMoney
         })
        return {
            form: {
                SsWarehouse:'',
