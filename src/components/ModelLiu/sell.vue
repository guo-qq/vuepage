<template>
  <div>
    ...
    >
      ...
      <el-table-column v-if="fales" prop="ssId" label="主键ID" width="100">
      </el-table-column>
      <el-table-column prop="ssZdDate" label="提交时间" width="200">
      </el-table-column>
      <el-table-column prop="ssNumber" label="单据编号" width="180">
      </el-table-column>
      <el-table-column prop="ssClient" label="客户名称" width="150">
      </el-table-column>
      <el-table-column prop="ssSjMoney" label="实收金额(元)" width="150">
      </el-table-column>
      <el-table-column prop="aswname" label="门店" width="150">
      </el-table-column
      >s
      <el-table-column prop="ssWarehouse" label="仓库" width="100">
      </el-table-column>
      <el-table-column prop="ssAudit" label="状态" width="100">
      ...
      <el-table-column fixed="right" label="操作" width="200">
        <template slot-scope="scope">
          ...
          >
          <el-button
            @click="removeData(scope.row.ssId)"
            type="text"
            size="small"
            >删除</el-button
          >
