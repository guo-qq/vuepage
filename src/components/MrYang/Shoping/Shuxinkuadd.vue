...
<template>
  <div>
    <div>
      <table style="marginleft: 1%; margintop: 20%">
        <tr>
          <td>
            <el-row>
                <router-link to="/zpropadd"><el-button style="marginLeft:1%;margintop:20%" type="primary">添加</el-button></router-link>
            </el-row>
          </td>
          <td>
          </td>
    ...
    >
      ...
      <el-table-column prop="unitDecimals" label="属性值" width="600">
    </el-table-column>
