...
const delay = (function() {
  ...
  export default {
    ...
    methods: {
        ...
        ztai(id){
        this.axios.post(this.$api+"/api/WarehouseZtai?id="+id +"&ztai="+1)
        this.$message({
                  message:'启用成功',
                   type: 'success',
                })
    ...
    zt(id){
        this.axios.post(this.$api+"/api/WarehouseZtai?id="+id +"&ztai="+0)
        this.$message({
                  message:'禁用成功',
                   type:'success',
                })
        ...
        upt(id){
         ...
         fetchData(val) {
        this.axios.get(this.$api+'/api/WarehouseShow',{
        params: {
            phone:this.ckname[0],
